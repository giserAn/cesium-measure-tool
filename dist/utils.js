 ...
 * @returns
 */
export const _cartesian2Degree = (p) => {
 ...
 * @returns
 */
export const _degree2Cartesian = (p) => {
 ...
 * @returns （米）
 */
export const _mathDistance = (p1, p2) => {
 ...
 */
export const _mathMidpoint = (p1, p2) => {
 ...
 * @private
 */
export const _calcDistance2text = (p1, p2) => {
    let text = '';
 ...
 * @private
 */
export const _calcAllDistance2text = (positions) => {
    let allDistance = 0;
 ...
 * @private
 */
export const _calcArea2text = (points) => {
    let text = '';
 ...
 * @private
 */
export const _mathAreaAndCenter = (points) => {
